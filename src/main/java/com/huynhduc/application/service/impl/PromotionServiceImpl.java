...
import com.huynhduc.application.model.request.CreatePromotionRequest;
import com.huynhduc.application.repository.PromotionRepository;
...
import static com.huynhduc.application.constant.Contant.DISCOUNT_PERCENT;
...
//        }
    ...
    @Override
    public Promotion getOneCouponCode() {
        return this.promotionRepository.getOneCouponCodeIsValid();
    }
}
