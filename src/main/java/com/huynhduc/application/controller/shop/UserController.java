...
import com.huynhduc.application.model.request.LoginRequest;
...
import com.huynhduc.application.security.JwtTokenUtil;
...
import static com.huynhduc.application.constant.Contant.MAX_AGE_COOKIE;
...
public class UserController {
    ...
    public ResponseEntity<Object> register(@Valid @RequestBody CreateUserRequest createUserRequest, HttpServletResponse response) {
        ...
        // Spring Security chỉ hiểu và làm việc với interface UserDetails.
    ...
    public ResponseEntity<Object> login(@Valid @RequestBody LoginRequest loginRequest, HttpServletResponse response) {
        ...
        try {
            ...
            if (!userDetails.getUser().isStatus()) {
                throw new BadRequestException("Tài khoản của bạn chưa được kích hoạt. Vui lòng kiểm tra email để xác thực.");
            }
            //Gen token
